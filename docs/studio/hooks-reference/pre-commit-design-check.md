...
1. For missing design sections: invoke the `ccgs-game-designer` agent to complete
   the document
2. For invalid JSON: invoke the `ccgs-tools-programmer` agent or fix manually
