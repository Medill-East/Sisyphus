# Example Session: $ccgs-gate-check Phase Transition — Systems Design → Technical Setup
...
**User:**
> Got it. I'll start with $ccgs-architecture-decision for this.
