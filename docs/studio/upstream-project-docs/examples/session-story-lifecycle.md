# Example Session: Full Story Lifecycle — $ccgs-story-readiness → Implement → $ccgs-story-done
...
**User:**
> $ccgs-story-readiness production/stories/STORY-MOV-001.md

### Turn 2: Agent Validates the Story

**Agent (via $ccgs-story-readiness):**
...
### Turn 10: User Tests Manually and Runs $ccgs-story-done

**User:**
> I've tested it in the scene — everything works. $ccgs-story-done production/stories/STORY-MOV-001.md

### Turn 11: Agent Runs Completion Review

**Agent (via $ccgs-story-done):**
...
>
> Suggest running `$ccgs-code-review src/gameplay/movement/` before marking complete. Not blocking.
>
> ---
