...
> 3. I'll brief ccgs-gameplay-programmer on simplified implementation
...
**User:**
> Yes, create all those documents and also notify the ccgs-gameplay-programmer about the scope change.
