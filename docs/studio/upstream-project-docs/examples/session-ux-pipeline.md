# Example Session: UX Pipeline — $ccgs-ux-design → $ccgs-ux-review → $ccgs-team-ui
...
## Part 1: HUD Design with $ccgs-ux-design
...
**Agent (ccgs-ux-designer, via $ccgs-ux-design):**
...
## Part 2: Inventory Screen with $ccgs-ux-design

### Turn 8: User Starts Inventory Screen

**User:**
> $ccgs-ux-design screen inventory
...
>
> Two issues must be resolved before handoff to $ccgs-team-ui:
>
...
## Part 4: Handoff to $ccgs-team-ui
...
>
> Handing off to `ccgs-art-director` for visual spec (color palette, typography, iconography aligned to art bible)...
>
...
- **Pattern library enforced by $ccgs-team-ui**: after this session, inventory drag-drop becomes a documented pattern in `design/ux/interaction-patterns.md` for all future screens to reference
