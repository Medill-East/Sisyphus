# Example Session: Using $ccgs-design-system to Author a GDD
...
**User:**
> $ccgs-design-system movement

## Turn 2: Agent Loads Context and Presents the Plan

**Agent (ccgs-game-designer, via $ccgs-design-system):**
...
>
> **Recommended next step:** Run `$ccgs-design-review design/gdd/movement-system.md` before moving to the next system in your queue (stamina is next in dependency order, per systems-index).
>
