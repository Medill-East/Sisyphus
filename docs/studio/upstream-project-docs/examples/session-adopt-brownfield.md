# Example Session: $ccgs-adopt — Brownfield Project Onboarding
...
## Turn 1: User Invokes $ccgs-adopt
...
**Agent (ccgs-technical-director, via $ccgs-adopt, context: fork):**
...
> | 2 | Retrofit `design/inventory.md` → GDD format | `$ccgs-design-system retrofit design/inventory.md` | HIGH | Adds 5 missing sections, keeps your existing content |
> | 3 | Retrofit `design/combat-notes.md` → GDD format | `$ccgs-design-system retrofit design/combat-notes.md` | HIGH | Adds 6 missing sections |
> | 4 | Convert `design/crafting-ideas.md` → full GDD | `$ccgs-design-system crafting` (new authoring, uses ideas as input) | MEDIUM | Not a retrofit — too informal to retrofit |
...
> | 7 | Set up production tracking | `$ccgs-sprint-plan new` | MEDIUM | After architecture phase |
>
...
>
> - ✅ `$ccgs-design-system [name]` — guided GDD authoring for any system
> - ✅ `$ccgs-design-system retrofit [path]` — fill missing sections in existing docs
...
>
> 1. Run `$ccgs-design-system retrofit design/inventory.md` — your most complete existing doc, easiest win
> 2. Run `$ccgs-design-system retrofit design/combat-notes.md`
> 3. Run `$ccgs-design-system crafting` — author crafting GDD using your ideas file as input
>
...
> Run:
> ```
> $ccgs-design-system retrofit design/inventory.md
> ```
>
...
- **Retrofit vs. new authoring**: `$ccgs-design-system retrofit` handles existing-but-incomplete docs; full `$ccgs-design-system` handles net-new docs. The adoption plan distinguishes which applies to each file.
