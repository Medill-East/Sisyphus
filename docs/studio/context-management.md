...
Codex subagent: Implement hitbox detection
<!-- /STATUS -->
```

- All three fields (Epic, Feature, Codex subagent) are optional — include only what applies
...
## Context Budgets by Codex subagent Type
