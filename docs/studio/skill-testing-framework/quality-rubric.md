...
Used by `$ccgs-skill-test category [name|all]` to evaluate skills beyond structural compliance.
...
| Metric | PASS criteria |
|---|---|
| **AN1 — Read-only scan** | Analysis phase uses only search/read tools; no Write or Edit during the scan itself |
...
| Metric | PASS criteria |
|---|---|
| **U1 — Passes all 7 static checks** | `$ccgs-skill-test static [name]` returns COMPLIANT with 0 FAILs |
...
**Agents**: ccgs-creative-director, ccgs-technical-director, ccgs-art-director, ccgs-producer

| Metric | PASS criteria |
|---|---|
| **D1 — Correct verdict vocabulary** | Returns APPROVE / CONCERNS / REJECT (or domain equivalent: REALISTIC/CONCERNS/UNREALISTIC for ccgs-producer) |
| **D2 — Domain boundary respected** | Does not make binding decisions outside its declared domain |
| **D3 — Conflict escalation** | When two departments conflict, escalates to correct parent (ccgs-creative-director or ccgs-technical-director) rather than unilaterally deciding |
| **D4 — Opus model tier** | Agent is assigned Opus model per coordination-rules.md |

### `lead`

**Agents**: ccgs-lead-programmer, ccgs-qa-lead, ccgs-narrative-director, ccgs-audio-director, ccgs-game-designer,
ccgs-systems-designer, ccgs-level-designer

| Metric | PASS criteria |
|---|---|
| **L1 — Domain verdict** | Returns a domain-specific verdict (e.g., FEASIBLE/INFEASIBLE for ccgs-lead-programmer, PASS/FAIL for ccgs-qa-lead) |
| **L2 — Escalates to shared parent** | Out-of-domain conflicts escalate to ccgs-creative-director (design) or ccgs-technical-director (tech) |
| **L3 — Sonnet model tier** | Agent is assigned Sonnet model (default) per coordination-rules.md |

### `specialist`

**Agents**: ccgs-gameplay-programmer, ccgs-ai-programmer, ccgs-technical-artist, ccgs-sound-designer,
ccgs-engine-programmer, ccgs-tools-programmer, ccgs-network-programmer, ccgs-security-engineer,
ccgs-accessibility-specialist, ccgs-ux-designer, ccgs-ui-programmer, ccgs-performance-analyst, ccgs-prototyper,
ccgs-qa-tester, ccgs-writer, ccgs-world-builder
...
**Agents**: ccgs-godot-specialist, ccgs-godot-gdscript-specialist, ccgs-godot-csharp-specialist,
ccgs-godot-shader-specialist, ccgs-godot-gdextension-specialist, ccgs-unity-specialist, ccgs-unity-ui-specialist,
ccgs-unity-shader-specialist, ccgs-unity-dots-specialist, ccgs-unity-addressables-specialist,
ccgs-unreal-specialist, ccgs-ue-blueprint-specialist, ccgs-ue-gas-specialist, ccgs-ue-umg-specialist,
ccgs-ue-replication-specialist

| Metric | PASS criteria |
|---|---|
| **E1 — Version-aware** | References engine version from `docs/engine-reference/` before suggesting API calls; flags post-cutoff risk |
| **E2 — File routing** | Routes file types to the correct sub-specialist (e.g., `.gdshader` → ccgs-godot-shader-specialist, not ccgs-godot-gdscript-specialist) |
...
**Agents**: ccgs-qa-tester, ccgs-qa-lead, ccgs-security-engineer, ccgs-accessibility-specialist
...
**Agents**: ccgs-devops-engineer, ccgs-release-manager, ccgs-live-ops-designer, ccgs-community-manager,
ccgs-analytics-engineer, ccgs-economy-designer, ccgs-localization-lead
