# Skill Test Spec: $ccgs-propagate-design-change

## Skill Summary

`$ccgs-propagate-design-change` handles GDD revision cascades. When a GDD is updated,
...
**Input:** `$ccgs-propagate-design-change design/gdd/[system].md`
...
**Input:** `$ccgs-propagate-design-change` (no argument)

**Expected behavior:**
1. Skill detects no argument is provided
2. Skill outputs a usage error: "No GDD specified. Usage: $ccgs-propagate-design-change design/gdd/[system].md"
