# Skill Test Spec: $ccgs-dev-story

## Skill Summary

`$ccgs-dev-story` reads a story file, loads all required context (referenced ADR,
...
- [ ] Has a next-step handoff at the end (`$ccgs-story-done`)
...
**Input:** `$ccgs-dev-story production/epics/[layer]/story-[name].md`
...
5. Skill recommends running `$ccgs-architecture-decision` to advance the ADR
...
**Input:** `$ccgs-dev-story` (no argument)
...
- [ ] Ends with next-step handoff: `$ccgs-story-done`
