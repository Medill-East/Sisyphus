# Skill Test Spec: $ccgs-art-bible

## Skill Summary

`$ccgs-art-bible` is a guided, section-by-section art bible authoring skill. It
...
- [ ] Has a next-step handoff (e.g., `$ccgs-asset-spec` or `$ccgs-design-system`)
...
- The art bible feeds into `$ccgs-asset-spec` — this relationship is noted in the
