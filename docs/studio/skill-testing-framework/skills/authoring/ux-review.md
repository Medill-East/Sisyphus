# Skill Test Spec: $ccgs-ux-review

## Skill Summary

`$ccgs-ux-review` validates an existing UX spec or HUD design document against
...
`$ccgs-ux-review` IS the review gate for UX specs.
...
- [ ] Has a next-step handoff (e.g., back to `$ccgs-ux-design` for revision, or proceed to implementation)

---

## Director Gate Checks

None. `$ccgs-ux-review` is itself the review gate for UX specs. No additional director
...
6. Handoff suggests returning to `$ccgs-ux-design hud` to fill in the section

**Assertions:**
- [ ] NEEDS REVISION verdict is returned (not APPROVED or MAJOR REVISION NEEDED)
- [ ] Specific missing content items are listed
- [ ] Handoff points back to `$ccgs-ux-design hud` for revision
- [ ] No files are written
...
**Input:** `$ccgs-ux-review settings-menu`
...
- [ ] Handoff suggests returning to `$ccgs-ux-design settings-menu`
...
**Input:** `$ccgs-ux-review inventory-screen`
...
3. Skill suggests running `$ccgs-ux-design inventory-screen` to create the spec first
4. No review is performed; no verdict is issued

**Assertions:**
- [ ] Error message names the missing file with full path
- [ ] `$ccgs-ux-design inventory-screen` is suggested as the remediation
...
- [ ] Ends with next-step handoff to `$ccgs-ux-design` for revision or implementation
