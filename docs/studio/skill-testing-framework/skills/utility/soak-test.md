# Skill Test Spec: $ccgs-soak-test

## Skill Summary

`$ccgs-soak-test` generates a structured soak test protocol — an extended runtime
...
- [ ] Has a next-step handoff (e.g., `$ccgs-regression-suite` or `$ccgs-release-checklist`)

---

## Director Gate Checks

None. `$ccgs-soak-test` is a QA planning utility. No director gates apply.
...
**Input:** `$ccgs-soak-test online-lobby 2h`
...
**Input:** `$ccgs-soak-test online-lobby 4h`
...
**Input:** `$ccgs-soak-test gameplay 30m`
...
**Input:** `$ccgs-soak-test combat 1h`
