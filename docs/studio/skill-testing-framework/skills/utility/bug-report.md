# Skill Test Spec: $ccgs-bug-report

## Skill Summary

`$ccgs-bug-report` creates a structured bug report document from a user description.
...
- [ ] Has a next-step handoff (e.g., `$ccgs-bug-triage` to reprioritize, `$ccgs-hotfix` for critical)

---

## Director Gate Checks

None. `$ccgs-bug-report` is an operational documentation skill. No director gates apply.
...
**Input:** `$ccgs-bug-report` (user describes: "Game crashes when player enters the boss arena")
...
**Input:** `$ccgs-bug-report` (user describes: "Audio randomly stops working")
...
**Input:** `$ccgs-bug-report` (user describes: "After finishing a level, the save system
