# Skill Test Spec: $ccgs-brainstorm

## Skill Summary

`$ccgs-brainstorm` facilitates guided game concept ideation. It presents 2-4 concept
...
is drafted: CD-PILLARS (ccgs-creative-director), AD-CONCEPT-VISUAL (ccgs-art-director),
TD-FEASIBILITY (ccgs-technical-director), and PR-SCOPE (ccgs-producer). In `lean` mode,
...
- [ ] Has a next-step handoff at the end (`$ccgs-map-systems`)
...
- [ ] Next-step handoff to `$ccgs-map-systems` is present
...
- [ ] Ends with next-step handoff: `$ccgs-map-systems`
