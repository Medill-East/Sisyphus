# Skill Test Spec: $ccgs-launch-checklist

## Skill Summary

`$ccgs-launch-checklist` generates and evaluates a complete launch readiness checklist
...
director gates apply — `$ccgs-team-release` orchestrates the full release pipeline. Verdicts:
...
- [ ] Has a next-step handoff (e.g., `$ccgs-team-release` or `$ccgs-day-one-patch`)

---

## Director Gate Checks

None. `$ccgs-launch-checklist` is a readiness audit utility. The full release pipeline
is managed by `$ccgs-team-release`.
