# Skill Test Spec: $ccgs-regression-suite

## Skill Summary

`$ccgs-regression-suite` maps test coverage to GDD requirements: it reads the
...
- [ ] Has a next-step handoff (e.g., `$ccgs-test-setup` if framework missing, `$ccgs-qa-plan` if plan missing)

---

## Director Gate Checks

None. `$ccgs-regression-suite` is a QA analysis utility. No director gates apply.
...
**Input:** `$ccgs-regression-suite sprint-004`
