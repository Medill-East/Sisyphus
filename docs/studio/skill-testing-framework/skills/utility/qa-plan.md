# Skill Test Spec: $ccgs-qa-plan

## Skill Summary

`$ccgs-qa-plan` generates a structured QA test plan for a feature or sprint milestone.
...
- [ ] Has a next-step handoff (e.g., `$ccgs-smoke-check` or `$ccgs-story-readiness`)

---

## Director Gate Checks

None. `$ccgs-qa-plan` is a planning utility. Story readiness gates are separate.
