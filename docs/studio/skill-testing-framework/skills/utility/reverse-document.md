# Skill Test Spec: $ccgs-reverse-document

## Skill Summary

`$ccgs-reverse-document` generates design or architecture documentation from existing
...
- [ ] Has a next-step handoff (e.g., `$ccgs-design-review` to validate the generated doc)

---

## Director Gate Checks

None. `$ccgs-reverse-document` is a documentation utility. No director gates apply.
...
**Input:** `$ccgs-reverse-document src/gameplay/health_system.gd`
...
**Input:** `$ccgs-reverse-document src/gameplay/enemy_ai.gd`
...
**Input:** `$ccgs-reverse-document src/gameplay/combat_system.gd src/gameplay/damage_resolver.gd`
...
**Input:** `$ccgs-reverse-document src/gameplay/inventory_system.gd`
...
3. Skill suggests checking the path or running `$ccgs-map-systems` to identify
   the correct source file
4. No document is created

**Assertions:**
- [ ] Error message names the missing file with the full path
- [ ] Alternative suggestion (check path or `$ccgs-map-systems`) is provided
