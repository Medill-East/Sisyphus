# Skill Test Spec: $ccgs-asset-spec

## Skill Summary

`$ccgs-asset-spec` generates per-asset visual specification documents from design
...
- [ ] Has a next-step handoff (e.g., assign to an artist, or `$ccgs-asset-audit` later)

---

## Director Gate Checks

None. `$ccgs-asset-spec` is a design documentation utility. Technical artists may
...
**Input:** `$ccgs-asset-spec goblin-enemy`
...
**Input:** `$ccgs-asset-spec player-sprite`
...
**Input:** `$ccgs-asset-spec goblin-enemy orc-enemy treasure-chest`
