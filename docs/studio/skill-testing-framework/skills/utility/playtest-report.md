# Skill Test Spec: $ccgs-playtest-report

## Skill Summary

`$ccgs-playtest-report` generates a structured playtest report from session notes or
...
- [ ] Has a next-step handoff (e.g., `$ccgs-bug-report` for new issues found, `$ccgs-design-review` for feedback)

---

## Director Gate Checks

None. `$ccgs-playtest-report` is a documentation utility. The CD-PLAYTEST gate is a
...
**Input:** `$ccgs-playtest-report` (user pastes session notes)
...
5. Next Steps: suggests `$ccgs-bug-report` for the framerate issue and `$ccgs-design-review`
...
**Input:** `$ccgs-playtest-report` (3-tester session)
...
- [ ] `$ccgs-bug-report` is NOT suggested for the already-reported issue
