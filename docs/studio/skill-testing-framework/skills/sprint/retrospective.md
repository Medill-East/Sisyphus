# Skill Test Spec: $ccgs-retrospective

## Skill Summary

`$ccgs-retrospective` generates a structured sprint or milestone retrospective
...
**Input:** `$ccgs-retrospective sprint-005`
...
- User re-runs `$ccgs-retrospective sprint-005` after changes
...
- User runs `$ccgs-retrospective sprint-005`
