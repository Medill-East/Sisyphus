# Skill Test Spec: $ccgs-milestone-review

## Skill Summary

`$ccgs-milestone-review` generates a comprehensive review of a completed milestone:
...
compiled (ccgs-producer reviews scope delivery). In lean and solo modes the gate is
...
**Input:** `$ccgs-milestone-review milestone-03`
...
4. PR-MILESTONE gate invoked; ccgs-producer approves
...
4. PR-MILESTONE gate runs; ccgs-producer notes the unresolved blockers
...
2. PR-MILESTONE gate invoked; ccgs-producer returns CONCERNS about scope drift
...
**Fixture:**
- User calls `$ccgs-milestone-review milestone-07`
- `production/milestones/milestone-07.md` does NOT exist

**Input:** `$ccgs-milestone-review milestone-07`
