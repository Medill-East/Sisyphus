# Skill Test Spec: $ccgs-test-flakiness

## Skill Summary

`$ccgs-test-flakiness` detects non-deterministic tests by analyzing test history logs
...
- [ ] Flakiness report is advisory for ccgs-qa-lead; skill does not auto-disable tests
