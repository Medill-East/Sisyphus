# Skill Test Spec: $ccgs-security-audit

## Skill Summary

`$ccgs-security-audit` audits the game for security risks including save data
...
### Case 5: Gate Compliance — No gate; ccgs-security-engineer invoked separately
...
4. Output notes: "For formal security review, consider engaging a ccgs-security-engineer agent"
