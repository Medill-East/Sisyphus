# Skill Test Spec: $ccgs-estimate

## Skill Summary

`$ccgs-estimate` estimates task or story effort using a relative-size scale (S / M /
...
**Input:** `$ccgs-estimate production/epics/combat/story-hitbox-detection.md`
...
**Input:** `$ccgs-estimate production/epics/online/story-lobby-matchmaking.md`
...
**Input:** `$ccgs-estimate production/epics/core/story-save-load.md`
...
**Input:** `$ccgs-estimate production/sprints/sprint-007.md`
...
**Input:** `$ccgs-estimate production/epics/core/story-item-pickup.md`
...
4. Skill notes: "Use this estimate in $ccgs-sprint-plan when selecting stories for the next sprint"

**Assertions:**
- [ ] No director gate is invoked regardless of review mode
- [ ] Output is purely informational — no approval or write prompt
- [ ] Next-step recommendation references `$ccgs-sprint-plan`
