# Skill Test Spec: $ccgs-content-audit

## Skill Summary

`$ccgs-content-audit` reads GDDs in `design/gdd/` and checks whether all content
...
2. Skill outputs: "No content specifications found in GDDs — run $ccgs-design-system first to define content lists"
...
- [ ] Output recommends running `$ccgs-design-system`
