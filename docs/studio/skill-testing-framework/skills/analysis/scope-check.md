# Skill Test Spec: $ccgs-scope-check

## Skill Summary

`$ccgs-scope-check` is a Haiku-tier read-only skill that analyzes a feature, sprint,
...
- [ ] Output suggests running `$ccgs-milestone-review` or creating a milestone
...
**Input:** `$ccgs-scope-check production/epics/combat/story-parry-timing.md`
