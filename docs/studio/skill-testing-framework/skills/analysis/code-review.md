# Skill Test Spec: $ccgs-code-review

## Skill Summary

`$ccgs-code-review` performs an architectural code review of source files in `src/`,
...
**Input:** `$ccgs-code-review src/gameplay/health_component.gd`
...
**Input:** `$ccgs-code-review src/ui/inventory_ui.gd`
...
**Input:** `$ccgs-code-review src/core/save_system.gd`
...
**Fixture:**
- User calls `$ccgs-code-review src/networking/`
- `src/networking/` directory does not exist

**Input:** `$ccgs-code-review src/networking/`
...
**Input:** `$ccgs-code-review src/gameplay/loot_system.gd`
...
- Test coverage checks (verifying corresponding test files exist) are a stretch
  goal not tested here; that is primarily the domain of `$ccgs-test-evidence-review`.
