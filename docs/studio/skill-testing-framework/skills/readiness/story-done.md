# Skill Test Spec: $ccgs-story-done

## Skill Summary

`$ccgs-story-done` closes the loop between design and implementation. Run at the
...
**Input:** `$ccgs-story-done production/epics/core/story-light-pickup.md`
...
**Input:** `$ccgs-story-done` (no argument)
...
**Input:** `$ccgs-story-done production/epics/core/story-light-pickup.md` (full mode)
