# Agent Test Spec: ccgs-technical-artist

## Agent Summary
Domain: Shaders, VFX, rendering optimization, art pipeline tools, and visual performance.
Does NOT own: art style decisions or color palette (ccgs-art-director), gameplay code (ccgs-gameplay-programmer).
...
- Explicitly states that art style decisions belong to `ccgs-art-director`
- Redirects the request to `ccgs-art-director`
...
- Does NOT change gameplay behavior of the explosion (delegates any gameplay impact to ccgs-gameplay-programmer)
...
- [ ] Redirects art style decisions to ccgs-art-director
