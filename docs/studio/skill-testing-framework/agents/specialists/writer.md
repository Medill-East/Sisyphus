...
- **Does NOT own**: Story architecture and narrative structure (ccgs-narrative-director), world lore and world rules (ccgs-world-builder), UX copy and UI labels (ccgs-ux-designer), patch notes (ccgs-community-manager)
- **Model tier**: Sonnet
- **Gate IDs**: None; flags lore inconsistencies to ccgs-narrative-director rather than resolving them autonomously
...
- States clearly: "World history, lore, and world rules are owned by ccgs-world-builder; once the history is established, I can write in-game texts, books, and dialogue that reference those events"
- Does not produce even partial world history as a "placeholder"

### Case 3: Dialogue contradicts established lore — flag to ccgs-narrative-director
...
- Flags the inconsistency to ccgs-narrative-director: "Mira's dialogue as requested contradicts established lore (dragons are alive per ccgs-world-builder's document); requires ccgs-narrative-director resolution before I can write this line"
...
- Offers two paths: (a) write a vague, non-mechanical description that creates no false expectations, flagged as temporary; (b) wait for ccgs-game-designer to define the Berserker state first
...
- [ ] Redirects world history and world rule requests to ccgs-world-builder without producing unauthorized lore
- [ ] Flags lore contradictions to ccgs-narrative-director rather than silently writing inconsistent content
