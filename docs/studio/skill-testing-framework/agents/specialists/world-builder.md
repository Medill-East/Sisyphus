# Agent Test Spec: ccgs-world-builder
...
- **Does NOT own**: Specific NPC or quest dialogue (ccgs-writer), game mechanics rules derived from world rules (ccgs-game-designer/ccgs-systems-designer), narrative story structure and arc design (ccgs-narrative-director)
- **Model tier**: Sonnet
- **Gate IDs**: None; escalates world rule/mechanic conflicts to ccgs-narrative-director and ccgs-game-designer jointly
...
- States clearly: "Dialogue writing is owned by ccgs-writer; I provide the world and faction context that informs the dialogue, including the faction's culture, tone, and speaking style"
- Offers to produce the faction's speaking style notes and cultural context that ccgs-writer would need to write consistent dialogue
...
- Routes the resolution to ccgs-narrative-director if no clear answer exists

### Case 4: World rule has gameplay implications — coordination with ccgs-game-designer
...
- Flags the coordination requirement: "This world rule has gameplay mechanics implications — ccgs-game-designer needs to define how this translates into player-facing mechanics; proceeding with the lore without the mechanics definition risks inconsistency"
- Does NOT unilaterally design the game mechanic — describes the lore rule and the mechanical territory it implies, then defers to ccgs-game-designer
...
- [ ] Redirects dialogue writing requests to ccgs-writer with contextual faction notes
...
- [ ] Identifies gameplay implications of world rules and flags coordination with ccgs-game-designer
...
- No automated runner; review manually or via `$ccgs-skill-test`
