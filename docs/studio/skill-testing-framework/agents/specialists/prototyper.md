# Agent Test Spec: ccgs-prototyper
...
- **Does NOT own**: Production source code in `src/` (ccgs-gameplay-programmer), design documents (ccgs-game-designer), production-grade architecture decisions (ccgs-lead-programmer / ccgs-technical-director)
- **Model tier**: Sonnet
...
- States clearly: "Prototyper produces throwaway code in prototypes/ to validate concepts; production implementation of validated mechanics is handled by ccgs-gameplay-programmer"
...
- [ ] Redirects production implementation requests to ccgs-gameplay-programmer with a transition document offer
