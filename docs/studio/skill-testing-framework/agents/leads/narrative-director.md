# Agent Test Spec: ccgs-narrative-director
...
**Does NOT own:** Visual art style (ccgs-art-director), technical systems or code (ccgs-lead-programmer), production scheduling (ccgs-producer), game mechanics rules (ccgs-game-designer).
...
Verified by reading the agent's `.codex/agents/ccgs-narrative-director.md` frontmatter:
...
**Scenario:** A developer asks ccgs-narrative-director to review and optimize the shader code used for the "ancient glow" visual effect on Archive artifacts.
**Expected:** Agent declines to evaluate shader code and redirects to the appropriate engine specialist (ccgs-godot-gdscript-specialist or equivalent shader specialist).
**Assertions:**
...
**Scenario:** A ccgs-writer has established in their latest dialogue that the ancient civilization "spoke only in song." The ccgs-world-builder's existing lore entries describe the same civilization communicating through written glyphs. Both are in the narrative domain, and the two creators disagree on which is canonical.
**Expected:** ccgs-narrative-director makes a binding canonical decision within their domain. They do not need to escalate to a higher authority for intra-narrative conflicts — this is within their declared domain authority. They issue a ruling (e.g., "glyph-writing is the canonical primary communication; song may be ritual/ceremonial") and direct both ccgs-writer and ccgs-world-builder to align their work to the ruling.
**Assertions:**
- [ ] Makes a binding canonical decision — does not defer this intra-narrative conflict to ccgs-creative-director
- [ ] Decision is clearly stated and provides a path to reconciliation for both parties
- [ ] Directs both parties (ccgs-writer and ccgs-world-builder) to update their respective documents to align
...
- Multi-document consistency check across a full chapter set is not covered — deferred to $ccgs-review-all-gdds integration.
- Narrative impact of mechanical changes (e.g., a game mechanic that undermines story tension) requires coordination with ccgs-game-designer and is not covered here.
