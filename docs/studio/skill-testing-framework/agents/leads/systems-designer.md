# Agent Test Spec: ccgs-systems-designer
...
**Does NOT own:** Narrative and lore (ccgs-narrative-director), visual design (ccgs-art-director), code implementation (ccgs-lead-programmer), conceptual mechanic rules (ccgs-game-designer — collaborates with).
...
Verified by reading the agent's `.codex/agents/ccgs-systems-designer.md` frontmatter:
...
**Scenario:** A ccgs-writer asks ccgs-systems-designer to draft the quest script for a side quest that rewards the player with a rare crafting ingredient.
**Expected:** Agent declines to write quest script content and redirects to ccgs-writer or ccgs-narrative-director.
**Assertions:**
...
**Scenario:** ccgs-game-designer wants a simple, 2-variable damage formula for player intuitiveness. ccgs-systems-designer argues that a 6-variable formula with elemental interactions is necessary for the depth of the combat system. Neither can agree on the right level of complexity.
**Expected:** ccgs-systems-designer presents the trade-offs clearly — the tuning granularity of the 6-variable system versus the player legibility of the 2-variable system — and escalates to ccgs-creative-director for a player experience ruling. The question of "how complex should the formula be for players" is a player experience question, not a pure math question.
**Assertions:**
- [ ] Presents the trade-offs between both approaches with specific examples
- [ ] Escalates to `ccgs-creative-director` for the player experience ruling
- [ ] Does not unilaterally impose the 6-variable formula over ccgs-game-designer's objection
...
- [ ] Escalates player-experience complexity trade-offs to ccgs-creative-director
