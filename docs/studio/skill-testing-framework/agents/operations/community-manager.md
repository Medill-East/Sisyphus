# Agent Test Spec: ccgs-community-manager
...
- **Does NOT own**: Technical patch content (ccgs-devops-engineer), QA verification and test execution (ccgs-qa-lead), bug fixes (programmers), brand strategy direction (ccgs-creative-director)
- **Model tier**: Sonnet
- **Gate IDs**: None; escalates brand voice conflicts to ccgs-creative-director
...
- Routes it: "This requires investigation by the appropriate programmer; I'm routing this to [ccgs-gameplay-programmer or ccgs-lead-programmer] for technical triage"
...
- Does NOT commit to a rollback on behalf of the design team — flags this as a ccgs-creative-director decision
...
- [ ] Does NOT commit to design rollbacks without ccgs-creative-director authority
