# Agent Test Spec: ccgs-economy-designer
...
- **Does NOT own**: Live ops event scheduling and structure (ccgs-live-ops-designer), code implementation, analytics tracking design (ccgs-analytics-engineer), narrative justification for economy systems (ccgs-writer)
- **Model tier**: Sonnet
- **Gate IDs**: None; escalates economy-breaking design conflicts to ccgs-creative-director or ccgs-producer
...
- States clearly: "Live ops event scheduling is owned by ccgs-live-ops-designer; I design the economic structure of rewards within events once the event schedule is defined"
- Offers to produce the reward value design for events once ccgs-live-ops-designer defines the structure
...
- [ ] Redirects live ops scheduling requests to ccgs-live-ops-designer without producing schedules
