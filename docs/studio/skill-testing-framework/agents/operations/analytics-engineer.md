# Agent Test Spec: ccgs-analytics-engineer
...
- **Does NOT own**: Game implementation of event tracking (appropriate programmer), economy design decisions informed by analytics (ccgs-economy-designer), live ops event design (ccgs-live-ops-designer)
- **Model tier**: Sonnet
...
- States clearly: "Telemetry implementation in game code is handled by the appropriate programmer (ccgs-gameplay-programmer or systems-programmer); I provide the event schema and integration requirements"
