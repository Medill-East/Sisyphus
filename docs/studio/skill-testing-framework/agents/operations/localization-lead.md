# Agent Test Spec: ccgs-localization-lead
...
- **Does NOT own**: Game narrative content and dialogue writing (ccgs-writer), code implementation of i18n calls (ccgs-gameplay-programmer), translation work itself (external translators)
- **Model tier**: Sonnet
- **Gate IDs**: None; escalates pipeline architecture decisions to ccgs-technical-director when they affect build systems
...
- States clearly: "ccgs-localization-lead owns the pipeline, quality standards, and workflow; actual translation work is performed by human translators or approved translation vendors — I am not a translator"
