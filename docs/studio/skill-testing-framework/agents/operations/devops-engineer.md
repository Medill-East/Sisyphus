# Agent Test Spec: ccgs-devops-engineer
...
- **Does NOT own**: Game logic or gameplay systems, security audits (ccgs-security-engineer), QA test strategy (ccgs-qa-lead), game networking logic (ccgs-network-programmer)
- **Model tier**: Sonnet
- **Gate IDs**: None; escalates deployment blockers to ccgs-producer
...
- States clearly: "Game networking implementation is owned by ccgs-network-programmer; I handle the infrastructure that builds, tests, and deploys the game"
