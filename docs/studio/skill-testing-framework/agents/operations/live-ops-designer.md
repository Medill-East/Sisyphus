# Agent Test Spec: ccgs-live-ops-designer
...
- **Does NOT own**: Economy math and reward value calculations (ccgs-economy-designer), analytics tracking implementation (ccgs-analytics-engineer), narrative content within events (ccgs-writer), code implementation
- **Model tier**: Sonnet
- **Gate IDs**: None; escalates monetization concerns to ccgs-creative-director for brand/ethics review
...
- States clearly: "Reward values and currency amounts are owned by ccgs-economy-designer; I design the event structure and define what rewards exist, then ccgs-economy-designer assigns their values"
- Offers to produce the reward structure (tiers, unlock gates, cosmetic categories) so ccgs-economy-designer has something concrete to value
...
- Notes that this decision has brand and ethics implications — escalates to ccgs-creative-director for approval before proceeding
...
- Escalates to ccgs-creative-director: this is a conflict between live ops content design and core game design pacing — requires a director-level decision
...
- [ ] Redirects reward value and economy math requests to ccgs-economy-designer
- [ ] Flags predatory monetization patterns and escalates to ccgs-creative-director rather than implementing them silently
- [ ] Escalates event/core-progression conflicts to ccgs-creative-director rather than resolving unilaterally
