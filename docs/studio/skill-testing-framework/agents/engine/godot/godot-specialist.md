# Agent Test Spec: ccgs-godot-specialist
...
- Defers the decision to `ccgs-lead-programmer` with the analysis as input
...
- [ ] Redirects language-specific implementation to ccgs-godot-gdscript-specialist or ccgs-godot-csharp-specialist
...
- [ ] Defers language-selection decisions to ccgs-lead-programmer when trade-offs exist
