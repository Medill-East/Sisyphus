# Agent Test Spec: ccgs-godot-gdscript-specialist
...
Does NOT own: shader code (ccgs-godot-shader-specialist), GDExtension bindings (ccgs-godot-gdextension-specialist).
...
- Explicitly states that shader authoring belongs to `ccgs-godot-shader-specialist`
- Redirects the request to `ccgs-godot-shader-specialist`
...
- [ ] Redirects shader requests to ccgs-godot-shader-specialist
