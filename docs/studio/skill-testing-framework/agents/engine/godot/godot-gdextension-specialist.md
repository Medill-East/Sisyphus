# Agent Test Spec: ccgs-godot-gdextension-specialist
...
Does NOT own: GDScript code (gdscript-specialist), shader code (ccgs-godot-shader-specialist).
...
- Redirects to `ccgs-godot-gdscript-specialist`
...
- [ ] Redirects GDScript authoring to ccgs-godot-gdscript-specialist
- [ ] Redirects shader authoring to ccgs-godot-shader-specialist
