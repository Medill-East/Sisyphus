# Agent Test Spec: ccgs-unreal-specialist
...
- **Does NOT own**: Art style and visual direction (ccgs-art-director), server infrastructure and deployment (ccgs-devops-engineer), UI/UX flow design (ccgs-ux-designer)
- **Model tier**: Sonnet
- **Gate IDs**: None; defers gate verdicts to ccgs-technical-director
...
- Notes the coordination required: changes to replication architecture must involve ccgs-lead-programmer
...
- [ ] Coordinates with ccgs-lead-programmer for architecture-scale refactors rather than deciding unilaterally

---

## Coverage Notes
- No automated runner exists for agent behavior tests — these are reviewed manually or via `$ccgs-skill-test`
...
- Case 4 integration with ccgs-lead-programmer is a coordination test, not a technical correctness test
