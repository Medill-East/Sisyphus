# Agent Test Spec: ccgs-ue-umg-specialist
...
- **Does NOT own**: UX flow and screen navigation design (ccgs-ux-designer), gameplay logic (ccgs-gameplay-programmer), backend data sources (game code), server communication
- **Model tier**: Sonnet
- **Gate IDs**: None; defers UX flow decisions to ccgs-ux-designer
...
- States clearly: "Navigation flow and screen transition design is owned by ccgs-ux-designer; I can implement the UMG widget structure once the flow is defined"
...
- [ ] Redirects UX flow and navigation design requests to ccgs-ux-designer
