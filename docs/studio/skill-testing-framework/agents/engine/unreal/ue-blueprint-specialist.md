# Agent Test Spec: ccgs-ue-blueprint-specialist
...
- **Does NOT own**: C++ implementation (ccgs-engine-programmer or ccgs-gameplay-programmer), art assets or shaders, UI/UX flow design (ccgs-ux-designer)
- **Model tier**: Sonnet
- **Gate IDs**: None; defers to ccgs-unreal-specialist or ccgs-lead-programmer for cross-domain rulings
...
- States clearly: "C++ implementation is handled by ccgs-engine-programmer or ccgs-gameplay-programmer; I can show the Blueprint approach or describe the boundary where Blueprint calls into C++"
...
- Notes that if the damage logic is performance-sensitive or shared with C++, it may be a candidate for migration to ccgs-unreal-specialist review
...
- [ ] Redirects C++ implementation requests to ccgs-engine-programmer or ccgs-gameplay-programmer
