# Agent Test Spec: ccgs-unity-specialist
...
Does NOT own: language-specific deep dives (delegates to ccgs-unity-dots-specialist, ccgs-unity-ui-specialist, etc.).
...
- Provides a concrete example of what the ScriptableObject class definition looks like (does not produce full code — refers to ccgs-engine-programmer or ccgs-gameplay-programmer for implementation)
...
- Recommends escalating the architecture decision to `ccgs-lead-programmer` or `ccgs-technical-director`
- Defers to `ccgs-unity-dots-specialist` for the DOTS-side implementation details
...
- [ ] Redirects DOTS implementation to ccgs-unity-dots-specialist
- [ ] Redirects UI implementation to ccgs-unity-ui-specialist
