...
**Escalates to**: [parent agent — e.g., ccgs-creative-director for design conflicts]
...
2. Agent escalates to the shared parent (or ccgs-creative-director / ccgs-technical-director)
