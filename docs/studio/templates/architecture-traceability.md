...
<!-- Living document — updated by $ccgs-architecture-review after each review run.
...
| TR-[gdd]-002 | [filename] | [system name] | [one-line summary] | — | ❌ GAP | Needs `$ccgs-architecture-decision [title]` |
...
**When running `$ccgs-architecture-review`**: The skill will update this document
