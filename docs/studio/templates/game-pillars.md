...
- **Version**: 1.0
- **Last Updated**: [Date]
- **Approved By**: ccgs-creative-director
...
6. If the conflict is fundamental (two pillars are irreconcilable), escalate to
   the ccgs-creative-director to consider revising the pillars themselves
...
- [ ] Get pillar approval from ccgs-creative-director
