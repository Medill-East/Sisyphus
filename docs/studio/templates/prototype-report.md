...
**Next steps:**
1. `$ccgs-design-review design/gdd/game-concept.md`
2. `$ccgs-gate-check`
3. `$ccgs-map-systems`
4. `$ccgs-design-system [mechanic]` (use learnings in Tuning Knobs and Formulas sections)
...
**Next step:** `$ccgs-prototype [revised-concept]`
...
**Next step:** `$ccgs-brainstorm [new-direction]`
