...
**Immediate**:
- [ ] [Codex subagent 1 — e.g., "Add missing unit tests"]
- [ ] [Codex subagent 2 — e.g., "Document edge case handling"]

**Short-Term**:
- [ ] [Codex subagent 3 — e.g., "Refactor X for clarity"]
- [ ] [Codex subagent 4 — e.g., "Add performance monitoring"]

**Long-Term**:
- [ ] [Codex subagent 5 — e.g., "Revisit decision when Y is available"]
...
*This ADR was generated by `$ccgs-reverse-document architecture [path]`*
