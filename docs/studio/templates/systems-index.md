...
|-------|--------|----------|-------|----------|-------------|
| 1 | [First system to design] | MVP | Foundation | ccgs-game-designer | [S/M/L] |
| 2 | [Second system] | MVP | Foundation | ccgs-game-designer | [S/M/L] |
...
- [ ] Design MVP-tier systems first (use `$ccgs-design-system [system-name]`)
- [ ] Run `$ccgs-design-review` on each completed GDD
- [ ] Run `$ccgs-gate-check pre-production` when MVP systems are designed
- [ ] Validate the highest-risk systems with `$ccgs-vertical-slice` before committing to Production
