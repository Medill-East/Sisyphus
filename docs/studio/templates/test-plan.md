...
**Who must sign off**: [designer / ccgs-lead-programmer / art-lead]
...
Critical paths to verify before QA hand-off (run via `$ccgs-smoke-check`):
...
*Results and sign-off are tracked in the QA sign-off report generated by `$ccgs-team-qa` — not in this plan file.*

*Template: `docs/studio/templates/test-plan.md`*
*Generated by: `$ccgs-qa-plan` — do not edit this line*
