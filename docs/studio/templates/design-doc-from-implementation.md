...
- Run `$ccgs-balance-check` on [specific aspect]
...
- [ ] **Balance pass**: Run `$ccgs-balance-check` on progression curve
...
**Related Skills**:
- `$ccgs-balance-check` — Validate formulas and progression
- `$ccgs-architecture-decision` — Document technical decisions
- `$ccgs-code-review` — Ensure code matches clarified design

---

*This document was generated by `$ccgs-reverse-document design [path]`*
