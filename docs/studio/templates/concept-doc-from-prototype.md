...
1. **[Codex subagent 1]**: [e.g., "Create full design doc for this system"]
2. **[Codex subagent 2]**: [e.g., "Write ADR for technical approach"]
3. **[Codex subagent 3]**: [e.g., "Add to backlog for Sprint X"]

### Before Production (If Needs More Work)
1. **[Codex subagent 1]**: [e.g., "Build second prototype testing X variation"]
2. **[Codex subagent 2]**: [e.g., "Playtest with 5+ people"]
3. **[Codex subagent 3]**: [e.g., "Investigate technical feasibility of Y"]

### If Abandoning
1. **[Codex subagent 1]**: [e.g., "Archive prototype with this document"]
2. **[Codex subagent 2]**: [e.g., "Extract reusable code/learnings"]
3. **[Codex subagent 3]**: [e.g., "Update game pillars if this changed thinking"]
...
*This concept document was generated by `$ccgs-reverse-document concept prototypes/[name]`*
