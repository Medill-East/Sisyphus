...
**Analysis Scope**: [Full project | Specific role: programmer/designer/ccgs-producer]
...
- `$ccgs-reverse-document [type] [path]` — [For which gap]
- `$ccgs-architecture-decision` — [For which gap]
- `$ccgs-sprint-plan` — [If production planning missing]
- `$ccgs-milestone-review` — [If approaching deadline]
- `$ccgs-onboard [role]` — [If new contributor joining]
...
*Generated by `$ccgs-project-stage-detect` skill*
