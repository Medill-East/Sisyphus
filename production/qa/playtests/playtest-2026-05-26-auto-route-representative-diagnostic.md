...
- **Duration**: 30.0s
- **Tester**: auto-route-representative-diagnostic
- **Platform**: macOS
...
## Quantitative Data
Push Gate: PROCEED | Burden Gate: PROCEED | Slice Gate: PIVOT | Contact: 100% | Loss: 1 | Dist: 2.57 | Spin: 1.0
- **Push Gate**: PROCEED
...
- **Estimated Pacing Loop**: 534.0s
- **Route Complete**: No
- **Route Status Reason**: frame budget exhausted before complete
- **Route Frames Run**: 1800 / 1800
- **Telemetry HUD**: Telemetry: ascent 30.0s | Contact 100% | Loss 1 | Dist 2.57 | Spin 1.0 | Effort 26.88m 7.4s | Push PROCEED | Burden PROCEED | Slice PIVOT
- **Trail Points**: 59
- **Response Points**: 0
- **Hum Clarity**: 0.00
- **Generated Hum Stream**: No
- **Route Smoke Teleports After Start**: 0
- **Route Smoke Max Lateral Offset**: 0.20
